...
namespace TourManagementSystem.ManagerView.Model
{
    public class TourTransportDetailModel : BaseViewModel
    {
        ...
        public int TOUR_TRANSPORT_DETAIL_ID { get => _TOUR_TRANSPORT_DETAIL_ID; set { _TOUR_TRANSPORT_DETAIL_ID = value; OnPropertyChanged(); } }
        ...
        public string TRAVEL_GROUP_NAME { get => _TRAVEL_GROUP_NAME; set { _TRAVEL_GROUP_NAME = value; OnPropertyChanged(); } }
        ...
        public DateTime END_DATE { get => _END_DATE; set { _END_DATE = value; OnPropertyChanged(); } }

        private string _STRING_START_DATE;
        public string STRING_START_DATE { get => _STRING_START_DATE; set { _STRING_START_DATE = value; OnPropertyChanged(); } }

        private string _STRING_END_DATE;
        public string STRING_END_DATE { get => _STRING_END_DATE; set { _STRING_END_DATE = value; OnPropertyChanged(); } }

        public TourTransportDetailModel(int id, string tour_name, string group_name, DateTime start_date, DateTime end_date)
        {
