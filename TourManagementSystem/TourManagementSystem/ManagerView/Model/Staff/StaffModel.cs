...
namespace TourManagementSystem.ManagerView.Model
{
    public class StaffModel : BaseViewModel
    {
        ...
        public string STAFF_CITIZEN_CARD
        { get => _STAFF_CITIZEN_CARD; set { _STAFF_CITIZEN_CARD = value; OnPropertyChanged(); } }

        private DateTime _STAFF_CITIZEN_CARD_DATE = DateTime.Now;

        public DateTime STAFF_CITIZEN_CARD_DATE
        { get => _STAFF_CITIZEN_CARD_DATE; set { _STAFF_CITIZEN_CARD_DATE = value; OnPropertyChanged(); } }

        private string _STAFF_STRING_CITIZEN_CARD_DATE;

        public string STAFF_STRING_CITIZEN_CARD_DATE
        { get => _STAFF_STRING_CITIZEN_CARD_DATE; set { _STAFF_STRING_CITIZEN_CARD_DATE = value; OnPropertyChanged(); } }

        private string _STAFF_CITIZEN_CARD_PLACE;

        public string STAFF_CITIZEN_CARD_PLACE
        { get => _STAFF_CITIZEN_CARD_PLACE; set { _STAFF_CITIZEN_CARD_PLACE = value; OnPropertyChanged(); } }

        private DateTime _STAFF_BIRTH_DATE = DateTime.Now;

        public DateTime STAFF_BIRTH_DATE
        { get => _STAFF_BIRTH_DATE; set { _STAFF_BIRTH_DATE = value; OnPropertyChanged(); } }

        private string _STAFF_STRING_BIRTH_DATE;

        public string STAFF_STRING_BIRTH_DATE
        { get => _STAFF_STRING_BIRTH_DATE; set { _STAFF_STRING_BIRTH_DATE = value; OnPropertyChanged(); } }
        ...
        public string STAFF_STRING_START_DATE
        { get => _STAFF_STRING_START_DATE; set { _STAFF_STRING_START_DATE = value; OnPropertyChanged(); } }
        ...
        public bool STAFF_IS_DELETE
        { get => _STAFF_IS_DELETE; set { _STAFF_IS_DELETE = value; OnPropertyChanged(); } }

        private string _STAFF_STATUS;

        public string STAFF_STATUS
        { get => _STAFF_STATUS; set { _STAFF_STATUS = value; OnPropertyChanged(); } }

        private string _STAFF_DELETE_NOTE;

        public string STAFF_DELETE_NOTE
        { get => _STAFF_DELETE_NOTE; set { _STAFF_DELETE_NOTE = value; OnPropertyChanged(); } }

        private DateTime _STAFF_DELETE_DATE = DateTime.Now;

        public DateTime STAFF_DELETE_DATE
        { get => _STAFF_DELETE_DATE; set { _STAFF_DELETE_DATE = value; OnPropertyChanged(); } }

        private string _STAFF_DELETE_STRING_DATE;

        public string STAFF_DELETE_STRING_DATE
        { get => _STAFF_DELETE_STRING_DATE; set { _STAFF_DELETE_STRING_DATE = value; OnPropertyChanged(); } }
