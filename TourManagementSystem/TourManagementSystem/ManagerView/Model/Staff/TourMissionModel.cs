...
namespace TourManagementSystem.ManagerView.Model
{
    public class TourMissionModel : BaseViewModel
    {
        ...
        public int TOUR_MISSION_ID
        { get => _TOUR_MISSION_ID; set { _TOUR_MISSION_ID = value; OnPropertyChanged(); } }
        ...
        public string TOUR_MISSION_RESPONSIBILITY
        { get => _TOUR_MISSION_RESPONSIBILITY; set { _TOUR_MISSION_RESPONSIBILITY = value; OnPropertyChanged(); } }

        private string _TOUR_MISSION_DESCRIPTION;

        public string TOUR_MISSION_DESCRIPTION
        { get => _TOUR_MISSION_DESCRIPTION; set { _TOUR_MISSION_DESCRIPTION = value; OnPropertyChanged(); } }

        private string _TOUR_MISSION_TOURNAME;

        public string TOUR_MISSION_TOURNAME
        { get => _TOUR_MISSION_TOURNAME; set { _TOUR_MISSION_TOURNAME = value; OnPropertyChanged(); } }

        private string _TOUR_MISSION_TRAVELGROUPNAME;

        public string TOUR_MISSION_TRAVELGROUPNAME
        { get => _TOUR_MISSION_TRAVELGROUPNAME; set { _TOUR_MISSION_TRAVELGROUPNAME = value; OnPropertyChanged(); } }

        private string _TOUR_MISSION_STRING_STARTDATE;

        public string TOUR_MISSION_STRING_STARTDATE
        { get => _TOUR_MISSION_STRING_STARTDATE; set { _TOUR_MISSION_STRING_STARTDATE = value; OnPropertyChanged(); } }

        private string _TOUR_MISSION_STRING_ENDDATE;

        public string TOUR_MISSION_STRING_ENDDATE
        { get => _TOUR_MISSION_STRING_ENDDATE; set { _TOUR_MISSION_STRING_ENDDATE = value; OnPropertyChanged(); } }

        private DateTime _TOUR_MISSION_STARTDATE = DateTime.Now;

        public DateTime TOUR_MISSION_STARTDATE
        { get => _TOUR_MISSION_STARTDATE; set { _TOUR_MISSION_STARTDATE = value; OnPropertyChanged(); } }

        private DateTime _TOUR_MISSION_ENDDATE = DateTime.Now;

        public DateTime TOUR_MISSION_ENDDATE
        { get => _TOUR_MISSION_ENDDATE; set { _TOUR_MISSION_ENDDATE = value; OnPropertyChanged(); } }

        private double _TOUR_MISSION_PRICE;

        public double TOUR_MISSION_PRICE
        { get => _TOUR_MISSION_PRICE; set { _TOUR_MISSION_PRICE = value; OnPropertyChanged(); } }
