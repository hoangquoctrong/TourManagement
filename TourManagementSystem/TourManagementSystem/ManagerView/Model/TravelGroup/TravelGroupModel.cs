...
namespace TourManagementSystem.ManagerView.Model
{
    public class TravelGroupModel : BaseViewModel
    {
        ...
        public string Tour_StartString
        { get => _Tour_StartString; set { _Tour_StartString = value; OnPropertyChanged(); } }

        private DateTime _Tour_Start = DateTime.Now;

        public DateTime Tour_Start
        { get => _Tour_Start; set { _Tour_Start = value; OnPropertyChanged(); } }

        private string _Tour_EndString;

        public string Tour_EndString
        { get => _Tour_EndString; set { _Tour_EndString = value; OnPropertyChanged(); } }
        ...
        { get => _Group_Status; set { _Group_Status = value; OnPropertyChanged(); } }

        private double _TourInformation_Price;

        public double TourInformation_Price
        { get => _TourInformation_Price; set { _TourInformation_Price = value; OnPropertyChanged(); } }
    }
}