...
namespace TourManagementSystem.ManagerView.Model
{
    public class TravelCostModel : BaseViewModel
    {
        ...
        public int TravelCost_ID { get => _TravelCost_ID; set { _TravelCost_ID = value; OnPropertyChanged(); } }

        private double _HotelPrice;
        public double HotelPrice { get => _HotelPrice; set { _HotelPrice = value; OnPropertyChanged(); } }

        private double _TransportPrice;
        public double TransportPrice { get => _TransportPrice; set { _TransportPrice = value; OnPropertyChanged(); } }

        private double _ServicePrice;
        public double ServicePrice { get => _ServicePrice; set { _ServicePrice = value; OnPropertyChanged(); } }
