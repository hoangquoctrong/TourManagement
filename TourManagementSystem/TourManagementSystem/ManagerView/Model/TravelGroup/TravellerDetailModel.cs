...
namespace TourManagementSystem.ManagerView.Model
{
    public class TravellerDetailModel : BaseViewModel
    {
        ...
        public int TravellerDetail_ID { get => _TravellerDetail_ID; set { _TravellerDetail_ID = value; OnPropertyChanged(); } }
        ...
        public int TravellerDetailStar_ID { get => _TravellerDetailStar_ID; set { _TravellerDetailStar_ID = value; OnPropertyChanged(); } }
    }
}
