...
namespace TourManagementSystem.ManagerView.Model
{
    public class TransportModel : BaseViewModel
    {
        ...
        { get => _TRANSPORT_TYPETRANS; set { _TRANSPORT_TYPETRANS = value; OnPropertyChanged(); } }
        ...
        { get => _TRANSPORT_STATUS; set { _TRANSPORT_STATUS = value; OnPropertyChanged(); } }
        ...
        public bool TRANSPORT_IS_AMOUNT
        { get => _TRANSPORT_IS_AMOUNT; set { _TRANSPORT_IS_AMOUNT = value; OnPropertyChanged(); } }

        private ObservableCollection<ComboBoxModel> _CB_TransportAmount;

        public ObservableCollection<ComboBoxModel> CB_TransportAmount
        { get => _CB_TransportAmount; set { _CB_TransportAmount = value; OnPropertyChanged(); } }
    }
}