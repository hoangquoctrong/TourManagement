...
namespace TourManagementSystem.ManagerView.Model
{
    public class TourLocationModel : BaseViewModel
    {
        ...
        { get => _LOACATION_ID; set { _LOACATION_ID = value; OnPropertyChanged(); } }
        ...
        public string TOUR_STRING_DATE
        { get => _TOUR_STRING_DATE; set { _TOUR_STRING_DATE = value; OnPropertyChanged(); } }

        private DateTime _TOUR_DATE = DateTime.Now;
        public DateTime TOUR_DATE
        { get => _TOUR_DATE; set { _TOUR_DATE = value; OnPropertyChanged(); } }
    }
}