...
namespace TourManagementSystem.ManagerView.Model
{
    public class TourDetailStatisticModel : BaseViewModel
    {
        ...
        public double Tour_Cost { get => _Tour_Cost; set { _Tour_Cost = value; OnPropertyChanged(); } }

        private int _Tour_NumberTraveller;
        public int Tour_NumberTraveller { get => _Tour_NumberTraveller; set { _Tour_NumberTraveller = value; OnPropertyChanged(); } }
    }
}
