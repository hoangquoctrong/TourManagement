...
namespace TourManagementSystem.ManagerView.ViewModel
{
    public class StaffViewModel : BaseViewModel
    {
        ...
        private void CheckboxDisplayStaff_Handle(bool checkboxDisplay)
        {
            if (StaffItems == null)
            {
                FilterText = "";
        ...
        public ICommand ShowDetailStaffCommand
        {
            get
            {
                ...
                {
                    _ShowDetailStaffCommand = new RelayCommand<ContentControl>(_ => true, p => p.Content = new ShowStaffViewModel(User_ID, StaffSelected));
                }
