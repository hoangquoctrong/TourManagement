...
namespace TourManagementSystem.Managers.Model
{
    public class TourTimeModel : BaseViewModel
    {
        ...
        public int TIME_ID { get => _TIME_ID; set { _TIME_ID = value; OnPropertyChanged(); } }

        private DateTime _TIME_DEPARTMENT_TIME = DateTime.Now;
        public DateTime TIME_DEPARTMENT_TIME { get => _TIME_DEPARTMENT_TIME; set { _TIME_DEPARTMENT_TIME = value; OnPropertyChanged(); } }
        ...
        public DateTime TIME_END_TIME { get => _TIME_END_TIME; set { _TIME_END_TIME = value; OnPropertyChanged(); } }
        ...
        public string TIME_STRING { get => _TIME_STRING; set { _TIME_STRING = value; OnPropertyChanged(); } }
    }
}
